...
contract("PlanetNFT unit tests", async (accounts) => {
  ...
  //     await planetNFT.setBaseURI("ipfs://GcredWorlds/");
  //     let baseURI = await planetNFT.baseURI();
  //     assert.equal(baseURI, "ipfs://GcredWorlds/")
  //   });
  //   it("Get token URI", async () => {
  //     let tokenURI = await planetNFT.tokenURI(201);
  //     assert.equal(tokenURI, "ipfs://GcredWorlds/201");
  //   });
  //   it("Update base token URI", async () => {
  //     await planetNFT.setBaseURI("ipfs://GcredWorldsV2/");
  //     baseURI = await planetNFT.baseURI();
  //     assert.equal(baseURI, "ipfs://GcredWorldsV2/")
  //   });
  //   it("Get updated token URI", async () => {
  //     tokenURI = await planetNFT.tokenURI(201);
  //     assert.equal(tokenURI, "ipfs://GcredWorldsV2/201")
  //   });
  // })
  // describe("Mint batch", () => {
  //   before(async () => {
